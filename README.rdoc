...
First of all, be sure to step into the root directory of your project, rubydeps searches for ./spec or ./test dirs from there, and then do:
...
This will output a rubydeps.dot. You can convert it to any image format you like with the dot utility e.g.:

  dot -Tsvg rubydeps.dot > rubydeps.svg && open rubydeps.svg
